...
$(document).ready(function () {
  ...
  var duration1 = 500;
  var score = 0;
  var percentOne = maxRotate / maxScore;
  var maxDeg;
  var arrow = $('.lvl__shape__arrow');
  var check = $('.skills__checkbox');
  var vlll = 0;
  var n = $('.lvl__count');
  ...
  function check1() {
    ...
    vlll = parseInt(n[0].textContent) > parseInt(n.attr('dataval')) ? n[0].textContent : n.attr('dataval');
    return score, vlll;
  }
  ...
  function anim() {
    $('.lvl__count').each(function () {
      ...
      $(this).prop('Counter', vlll).animate({
        Counter: score
      }, {
        duration: duration1,
        easing: 'swing',
...
/* harmony import */ var _lvl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lvl */ "./src/js/lvl.js");
/* harmony import */ var _lvl__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_lvl__WEBPACK_IMPORTED_MODULE_2__);
